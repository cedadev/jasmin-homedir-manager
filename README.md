...
* Teardown training accounts.
  ...
  * This script undertakes the following actions:
    * Get list of training accounts requiring teardown.
...
* Remove inactive user accounts.
  ...
  * This script will undertake the following separate actions:
    ...
    2. Remove expired home directories.
        ...
        * Remove the user's home directory from /home/users/.pending_deletion.
...
* Perform filesystem operations on user home directories as required.
* Update the portal API with the change required.
